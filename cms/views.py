...
def place_list(request, elements=None):
    ...
    fields = []
    exclude = ['en_titulo', 'subtitulo', 'en_subtitulo', 'en_informacion', 'informacion', 'servicios', 'en_servicios', 'latitud', 'longitud', 'telefono1', 'telefono2', 'url', 'reserva', 'compra', 'vista360']
